  ...
  describe('Trap creation', function () {
    ...
    it('Create a trap with logged user', done => {
      ...
      trapService.create({
        ...
        .then(trap => {
          if (trap && typeof trap.id == 'string') done();
